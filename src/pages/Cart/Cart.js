...
export default function Cart() {
    ...
    const handleDisplayProductsInCart = () => {
        return cartList.map((item, index) => {
            ...
            return <tr className='pb-0' key={index} style={{ borderBottom: '1px solid rgba(166, 157, 157, 0.3)' }}>
                <td>
            ...
            <div className='bg-gray-100 p-3'>
                <div className={styles.cart__contains__items}>
                    <div className='grid grid-cols-3 gap-12'>
                        <div className='col-span-2 bg-white p-3' style={{ border: '1px solid rgba(0, 0, 0, 0.1)', boxShadow: '3px 4px 9px 0 rgba(0, 0, 0, 0.4)' }}>
                        ...
                        <div className='p-3 bg-white' style={{ border: '1px solid rgba(0, 0, 0, 0.1)', boxShadow: '3px 4px 9px 0 rgba(0, 0, 0, 0.4)' }}>
