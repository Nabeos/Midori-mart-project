...
import styles from "./SuccessfulOrderDeliveryDetail.module.css";
export default function SuccessfulOrderDeliveryDetail() {
  return (
    <div>
         <div>
      ...
      <div>
        ...
        <div className="overflow-y-auto" style={{height:"30rem"}}>
          <table
            className={`${styles.successfulorderdeliverydetail__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-3`}
          >
            <thead>
              <tr>
