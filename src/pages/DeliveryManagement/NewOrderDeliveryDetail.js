...
import styles from "./NewOrderDeliveryDetail.module.css";
      ...
      <div className="">
        ...
        <div>
          ...
          <div className="overflow-y-auto" style={{ height: "30rem" }}>
            <table
              className={`${styles.neworderdeliverydetail__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-3`}
            >
              <thead>
                <tr>
          ...
          <div className="flex justify-end items-center mt-3" style={{width:"98%"}}>
            <Button className="text-lg rounded-md bg-green-700 border-green-700 text-white no-shadow hover:bg-green-700 hover:border-green-700 hover:text-white focus:bg-green-700 focus:border-green-700 focus:text-white">Đã lấy hàng</Button>
          </div>
        </div>
      </div>
    </div>
