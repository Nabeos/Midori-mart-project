...
import CustomerSuccessfulOrderDetail from './CustomerSuccessfulOrderDetail';
import styles from "./CustomerSuccessfulOrderInformation.module.css";
import { Button, Form, Modal, Popover, Pagination, Input, Tabs } from "antd";
import { NavLink } from "react-router-dom";
import { FaEye } from "react-icons/fa";
export default function CustomerSuccessfulOrderInformation() {
    ...
    return (
      <div>
        ...
        <table
          className={`${styles.customersuccessfulordermanagement__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-5 `}
