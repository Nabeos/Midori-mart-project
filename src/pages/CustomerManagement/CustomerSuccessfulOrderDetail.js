...
import styles from './CustomerSuccessfulOrderDetail.module.css';
export default function CustomerSuccessfulOrderDetail() {
    return (
        <div className="">
          <div className="">
            ...
            <div>
              ...
              <div className="overflow-y-auto" style={{ height: "30rem" }}>
                <table
                  className={`${styles.customersuccessfulorderdetail__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-3`}
                >
                  <thead>
                    <tr>
