...
import styles from "./CustomerDetailInformation.module.css";
...
export default function CustomerDetailInformation() {
    return (
                  ...
                  <div style={{ width: "100%" }}>
                    ...
                    <Form.Item name="lastname">
                      <Input
                        type="text"
                        id="last_name"
                        className={`${styles.customerdetailinformation__border__hover} text-gray-900 text-base rounded-lg shadow-none focus:border-green-900 block w-full p-2.5`}
                        placeholder="Họ"
