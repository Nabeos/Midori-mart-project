...
function Product(props) {
  ...
  return (
    <div className="">
      <div
        className={`${styles.productlist__relatedproduct__border} ml-3 mt-3 -mb-3 mr-3 pr-5 pl-5 bg-white`}
      ...
      >
        <div key={product.id} className="product">
          ...
          <div className="product-details flex flex-col items-start -mt-14">
            <header
