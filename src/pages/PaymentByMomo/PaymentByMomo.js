                    ...
                    <div className='' style={{ boxShadow: '1px 1px 5px 0 rgba(0, 0, 0, 0.2)', width: '480px', height: '625px' }}>
                        ...
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <div className='text-center'>
                                ...
                                <p className='text-sm ml-3 h-fit mb-0'> <img src="https://payment.momo.vn/gw_payment/faces/javax.faces.resource/material/img/qr-code-1.png" className='inline mr-2' style={{ width: '20px' }} />Sử dụng App MoMo hoặc<br />
