...
export default function PaymentMethod() {
    ...
    const handleRenderProductsInCart = () => {
        return cartList.map((item, index) => {
            ...
            return <div className='flex justify-between -mb-5' key={index}>
                <div className='flex'>
                    <img src={item.image} className="rounded-md mr-2 relative" style={{ height: '75%', border: '1px solid #D3D3D3' }} />
                    <div>
                    ...
                    <div class="card text-black mb-3">
                        ...
                        <div className="flex items-center card-footer bg-white h-16">
                            ...
                            <div className='flex items-center'>
                                <img src="https://hstatic.net/0/0/global/design/seller/image/payment/momo.svg?v=1" />
