...
import styles from "./ShipperSuccessfulOrderInformation.module.css";
export default function ShipperSuccessfulOrderInformation() {
  return (
    <div className="">
      <div className="">
        ...
        <div>
          ...
          <div>
            ...
            <div className="text-base">
              Trạng thái đơn hàng:
              <span className="text-green-700"> Giao thành công</span>
            </div>
          </div>
          <div className="overflow-y-auto" style={{ height: "30rem" }}>
            <table
              className={`${styles.shippersuccessfulorderinformation__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-3`}
            >
              <thead>
                <tr>
