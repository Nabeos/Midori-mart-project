...
import ShipperSuccessfulOrderInformation from './ShipperSuccessfulOrderInformation';
import styles from "./ShipperSuccessfulOrderManagement.module.css";
import { Button, Form, Modal, Popover, Pagination, Input, Tabs } from "antd";
import { NavLink } from "react-router-dom";
import { FaEye } from "react-icons/fa";
export default function ShipperSuccessfulOrderManagement() {
  ...
  return (
    <div>
      ...
      <table
        className={`${styles.shippersuccessfulordermanagement__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-5 `}
      ...
      >
        ...
        <tbody>
          <tr>
            ...
            <td className="border border-slate-300 text-center"><span className="p-2 bg-green-700 rounded-md text-white">Giao thành công</span></td>
            ...
            <td className="border border-slate-300 text-center">
              ...
              <Modal
                ...
                width={900}
              >
                <ShipperSuccessfulOrderInformation />
              </Modal>
            </td>
          </tr>
          <tr>
