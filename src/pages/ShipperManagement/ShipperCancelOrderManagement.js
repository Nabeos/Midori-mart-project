...
import styles from "./ShipperCancelOrderManagement.module.css";
...
export default function ShipperCancelOrderManagement() {
  ...
  return (
    <div>
      ...
      <table
          className={`${styles.shippercancelordermanagement__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-5 `}
        ...
        >
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-slate-300 text-center"><span className="p-2 bg-red-700 rounded-md text-white">Đã bị hủy</span></td>
