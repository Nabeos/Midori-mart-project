          ...
          <Form className="" style={{ width: "90%" }}>
            ...
            <div className="flex justify-end mb-2" style={{ width: "100%" }}>
              <Button
                type="default"
                htmlType="submit"
                className={`${styles.productdetailmanagement__border__button} pt-3 pb-5 font-semibold text-lg focus:border-green-700 focus:text-green-700`}
                style={{ width: "10%" }}
              >
                CẬP NHẬT
              </Button>
              <Button
                type="default"
                htmlType="submit"
                className={`${styles.productdetailmanagement__delete__button} pt-3 pb-5 font-semibold text-lg focus:border-red-400 focus:text-red-400`}
                style={{ width: "10%" }}
              >
                XÓA
              </Button>
