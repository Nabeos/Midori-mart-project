              ...
              <div className="mt-3 ml-3">
                <div className="flex">
                  ...
                  <div className="flex justify-end" style={{ width: "90%" }}>
                    <Button
                      className={`${styles.exportsheet__border__confirm}  mr-2`}
                    >
                      Xác nhận tạo phiếu
                    </Button>
                    <Button
                      className={`${styles.exportsheet__border__cancel}  mr-5`}
                    >
                      Hủy phiếu
                    </Button>
                  </div>
                ...
                <div>
                  ...
                  <div className="">
                    <table
                      className={`${styles.exportsheet__table__striped} table-auto border-collapse border border-slate-400 mt-3 mb-5 `}
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="border border-slate-300 text-center">
                            ...
                            <Modal
                              open={openEdit}
                              title="Chỉnh sửa sản phẩm xuất kho"
